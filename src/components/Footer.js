...
export const Footer = ({ sections }) => {
  ...
  return (
    <footer className="pt-12 mt-8 border-t bg-gray-50">
      <ContainerX className="divide-y divide-gray-200 space-y-8">
        <ul className="grid sm:gap-6 grid-cols-3 sm:grid-cols-6 gap-y-10">
          {renderSections}
        </ul>
          ...
          <div className="flex items-center">
            ...
            >
              <g
                ...
                fillRule="evenodd"
              >
                <g id="Rounded" transform="translate(-408.000000, -244.000000)">
            ...
            <p className="">
              2017-2021 travelsalem.com by Travel Salem - Salem, Oregon
            </p>
          </div>
      ...
      <div className="p-8 text-center text-white bg-black">
